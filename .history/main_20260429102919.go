...
func initDB() {
	...
	if count == 0 {
		sampleProducts := []Product{
			{Category: "マウス", Manufacturer: "Logitech", Name: "Wireless Mouse M100", Barcode: "490001"},
			{Category: "セキュリティワイヤー", Manufacturer: "Kensington", Name: "Kensington Lock", Barcode: "490002"},
			{Category: "ノートPC", Manufacturer: "Dell", Name: "XPS 13", Barcode: "490003"},
			{Category: "一体型PC", Manufacturer: "Apple", Name: "iMac 24", Barcode: "490004"},
			{Category: "モニター", Manufacturer: "Samsung", Name: "27\" UHD Monitor", Barcode: "490005"},
			// Add more as needed
		}
